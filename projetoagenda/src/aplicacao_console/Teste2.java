...
public class Teste2 {
	...
	public static void teste_Compromissoss() {
		System.out.println("\n------------------------------------------------");
		...
		try {
			...
			Compromissos comp4 = Fachada.cadastrarCompromissoEmGrupo("Churrasco",10,8,2019,10,00,"festa",nomes);
			Compromissos comp5 = Fachada.cadastrarCompromissoEmGrupo("Reunião",10,8,2019,12,00,"aula",nomes);
...
//			Compromissos comp3 = Fachada.cadastrarCompromissos("jantar", "2","1","2019", "20","00", "LAZER");
			...
			ArrayList<Compromissos> resultado = Fachada.listarCompromissosPorNome("") ;
			System.out.println("\nLISTAGEM GERAL:\n"+resultado);
	...
	public static void teste_erros() {
		...
		try {
			//Fachada.cadastrarContato("teste","teste@gmail.com","58055000","rua x","100","link",3,1,1);
			//Fachada.cadastrarContato("teste","teste@gmail.com","58055000","rua x","100","link",3,1,1);
