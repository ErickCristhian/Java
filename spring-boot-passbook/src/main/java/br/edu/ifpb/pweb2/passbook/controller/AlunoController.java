...
import br.edu.ifpb.pweb2.passbook.service.AlunoService;
	...
	public ModelAndView cadastrarNotas(@PathVariable("id") Integer id,
		...
		if (session.getAttribute("usuarioLogado") != null) {
			...
			try {
				...
				if(aluno.calculaSituacao() != null) {
					aluno.setSituacao(aluno.calculaSituacao());
				}
	...
	public ModelAndView cadastrarNotaFinal(@PathVariable("id") Integer id,
		...
		if (session.getAttribute("usuarioLogado") != null) {
			...
			try {
				...
				if(aluno.calculaSituacaoFinal() != null) {
					aluno.setSituacao(aluno.calculaSituacaoFinal());					
				}
