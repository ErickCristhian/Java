...
import br.edu.ifpb.pweb2.passbook.service.LoginService;
...
public class LoginController {
	...
	public ModelAndView valide(Usuario usuario, HttpSession session, ModelAndView modelAndView, RedirectAttributes flash) {
